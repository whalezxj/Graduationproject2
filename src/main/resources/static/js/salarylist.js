...
function toSomePage(pn) {
    $.ajax({
        url: "/staffmanagement/salarylist", type: "post",
        data: "pn=" + pn,
...
function build_user_table(result) {
    ...
    $.each(staffs, function (index, item) {
        dept += "<tr><td id='salaryStaffId' class='id'>" + item.salaryStaffId + "</td>";
        ...
        dept += "<td id='salaryWorkDay'>" + item.salaryWorkDay + "</td>";
        dept += "<td id='salaryBase'>" + item.salaryBase + "</td>";
        dept += "<td id='salaryBonus'>" + item.salaryBonus + "</td>";
        dept += "<td id='transportationAllowance'>" + item.transportationAllowance + "</td>";
        dept += "<td id='lunchAllowance'>" + item.lunchAllowance + "</td>";
        dept += "<td id='communicationAllowance'>" + item.communicationAllowance + "</td>";
        dept += "<td id='salaryTotal'>" + item.salaryTotal + "</td>";
        dept += "<td id='staffStatus'>" + item.staffStatus + "</td></tr>";
    });
    $("#dept").html(dept);
}
...
function addstaff() {
    var str = {
        "salaryStaffId": $('#salaryStaffId').val(),
        "salaryWorkDay": $('#salaryWorkDay').val(),
        "salaryBase": $('#salaryBase').val(),
        "salaryBonus": $('#salaryBonus').val()
    };
